...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        $permissions = [
            ...
            ['name' => 'district.create', 'guard_name' => 'admin', 'group_name' => 'district', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'district.view', 'guard_name' => 'admin', 'group_name' => 'district', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'district.edit', 'guard_name' => 'admin', 'group_name' => 'district', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'district.delete', 'guard_name' => 'admin', 'group_name' => 'district', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'district.export', 'guard_name' => 'admin', 'group_name' => 'district', 'created_at' => now(), 'updated_at' => now()],
