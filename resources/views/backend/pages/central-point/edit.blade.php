...
@section('admin-content')
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Central Points</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li><span>Central Points</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <form action="{{ route('admin.central-points.update',$centralPoint->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <!--Left Column-->
                            ...
                            <div class="card">
                                <div class="p-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('name', $centralPoint->name) }}" name="name" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="location">Location</label>
                                        <input type="text" name="longitude" value="{{$centralPoint->longitude}}" id="longitude" hidden>
                                        <input type="text" name="latitude" value="{{$centralPoint->latitude}}"  id="latitude" hidden>
                                        <input type="text" name="district" value="{{$centralPoint->district}}"  id="district" hidden>
                                        <input type="text" class="form-control bksearch" value="{{$centralPoint->location}}"  name="location" id="location"/>
                                    ...
                                    <button type="submit" class="btn btn-primary">Update Central Point</button>
    ...
    <script>
        ...
        const centralPointLongitude = {{ $centralPoint->longitude ?? 90.3938010872331 }};
        const centralPointLatitude = {{ $centralPoint->latitude ?? 23.821600277500405 }};
        const centralPointLocation = "{{ $centralPoint->location ?? '' }}";
