...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">{{ __('Central Points') }}</h4>
                    <p class="float-right mb-2">
                        @if (auth()->user()->can('admin.edit'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.central-points.create') }}">
                                {{ __('Create New Central Point') }}
                            </a>
                        @endif
                    </p>
        ...
        if ($('#dataTable').length) {
            $('#dataTable').DataTable({
                ...
                columnDefs: [
                    ...
                    { width: "50%", targets: 2 },  // Location column
